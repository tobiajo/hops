...
public class YarnCluster {
  ...
  private static final Log LOG =
      LogFactory.getLog(YarnCluster.class);
  ...
  protected void setupInternal(int numNodeManager) throws Exception {
    ...
    // conf.set("yarn.log-aggregation-enable", "true"); // for aggregated logs
    ...
    if (yarnCluster == null) {
      yarnCluster =
          new MiniYARNCluster(YarnCluster.class.getSimpleName(), 1,
              numNodeManager, 1, 1);
  ...
  protected boolean dumpAggregatedContainerLogs(ApplicationId appId)
      throws Exception {
  ...
  protected boolean dumpRemoteContainersLogs(ApplicationId appId) {
    File logFolder =
