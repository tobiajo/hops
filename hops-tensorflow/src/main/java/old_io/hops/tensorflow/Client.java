...
public class Client {
    ...
    private ContainerLaunchContext createContainerLaunchContext(GetNewApplicationResponse newAppResponse) throws IOException {
        ApplicationId appId = newAppResponse.getApplicationId();

        Map<String, LocalResource> localResources = new HashMap<>();
        Utils.addFileToLocalResources(localResources, yarnConf, appId, clientConf.get(ClientConf.JAR), "AppMaster.jar");
    ...
    private ApplicationSubmissionContext createApplicationSubmissionContext(YarnClientApplication newApp, ContainerLaunchContext containerContext) {
        ...
        appContext.setResource(Resource.newInstance(getAmMemory(newAppResponse), getAmVCores(newAppResponse)));
    ...
    private int getAmVCores(GetNewApplicationResponse newAppResponse) {
        ...
        int maxVCores = newAppResponse.getMaximumResourceCapability().getVirtualCores();
    ...
    private void logClusterInfo(YarnClient yarnClient) throws IOException, YarnException {
        ...
        QueueInfo queueInfo = yarnClient.getQueueInfo(clientConf.get(ClientConf.QUEUE_NAME));
        LOG.info("Queue info"
